  ...
  return (
    ...
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <div  className='flex items-center' >
            ...
            <div className='hidden lg:flex items-cover bg-gray-200 rounded-full p-1 text-[14px]'>
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
            ...
            <h2 className='text-2xl p-4'>Best <span className='font-bold'>Eeat</span></h2>
            <nav>
                ...
                `   <li className='text-xl py-4 flex'><AiFillTag size={25} className='mr-4' /> promtions</li>
